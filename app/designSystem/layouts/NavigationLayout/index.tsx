...
export const NavigationLayout: React.FC<Props> = ({ children }) => {
  ...
  const items: NavigationItem[] = [
    ...
    {
      key: '/organizations/:organizationId/ideas',
      label: 'Ideas Explorer',
      position: 'leftbar',

      isVisible: !!organization,
      onClick: () =>
        goTo(
          '/organizations/:organizationId/ideas'.replace(
            ':organizationId',
            organization.id,
          ),
        ),
    ...
    {
      key: '/organizations/:organizationId/ideas/create',
      label: 'Create Idea',
      position: 'leftbar',
      ...
      onClick: () =>
        goTo(
          '/organizations/:organizationId/ideas/create'.replace(
            ':organizationId',
            organization.id,
          ),
        ),
    ...
    {
      key: '/organizations/:organizationId/workspaces',
      label: 'Workspaces',
      position: 'leftbar',
      ...
      onClick: () =>
        goTo(
          '/organizations/:organizationId/workspaces'.replace(
            ':organizationId',
            organization.id,
          ),
        ),
